...
namespace eFacturesCat.Secure
{
    ...
    /// </summary>
    public class SecuredFacturae3_2_2:SecuredInvoice
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="xmlInvoice">The facturae 3.2 invoice to be signed</param>
        public SecuredFacturae3_2_2(GlobalInvoice xmlInvoice) : base(xmlInvoice) { }

        /// <summary>
        /// Constructor from secured filename
        /// </summary>
        /// <param name="fileName">The fileName of secured invoice</param>
        public SecuredFacturae3_2_2(String fileName)
            : base(fileName)
        {
